...
public class TestCases {
    ...
    void testCustomerByName(){
        ...
        assertDoesNotThrow(() ->{
            ...
            when(restaurantRepository.findByRestaurantNameAndAddress("name" , "address")).thenReturn(Optional.of(new Restaurant()));
            Restaurant restaurant = restaurantService.restaurantByRestaurantNameAndAddress
